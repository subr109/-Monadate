    ...
    try {
      ...
      const replyText =
        ...
        (progress.stage === 'Stranger'
          ? `Nice to chat with you. Tell me more about what you like to do 😊`
          : `I really enjoy chatting with you, ${currentUser?.displayName || 'friend'}.`);
      ...
      if (data.generatedPhoto) {
        setGeneratedPhotos((prev) => [data.generatedPhoto, ...prev]);
      }
      ...
      setRelationshipData((prev) => {
        ...
        return {
          ...
          [companionId]: {
            ...
            currentMood: data.mood || cur.currentMood
          }
        };
      });
      ...
      console.warn('Network or chat handled fallback:', err);
      const fallbackAiMsg: Message = {
        ...
        text:
          progress.stage === 'Stranger'
            ? `I'm listening. Tell me more about yourself and what you like to do 😊`
            : `I'm listening closely, ${currentUser?.displayName || 'friend'}. Tell me what's on your mind.`,
        timestamp: new Date().toLocaleTimeString([], {
          hour: '2-digit',
          minute: '2-digit'
        })

...
export function detectLanguagePipeline(userMessage: string): LanguageDetectionResult {
  ...
  if (hasLatin) {
    ...
    const banglishRegex =
      /\b(ami|aami|kemon|acho|achis|achen|achi|achhi|chilam|chilo|chile|bhalo|valo|bhalobashi|valobashi|valobasi|bhalobasi|tomake|tomaye|amar|amake|tumi|tmi|apni|tui|shona|sona|khub|bhabchi|bhabte|mone|pore|kotha|bolbo|bolte|katlo|korcho|korchi|korchis|korechi|korecho|korlam|hobe|hoyni|hoyeche|hoye|geche|sotti|shotti|kichu|onek|ekhon|jani|dekhbo|dekhe|shathe|sathe|thakba|thakbe|khabar|kheyecho|bondhu|moner|keno|kobe|din ta|dinta|ghuma|ghumao|mon|buker|pagol|pagli|raat|shomoy|parchi|bujhte|bujhchi|kothay|kothai|tmk|ki korcho|ki koro|bolo na|amio|korbo)\b/i;

    // Distinct Hinglish keywords & short forms (Romanized Hindi/Urdu)
    const hinglishRegex =
      /\b(main|mein|kaise|kaisi|kaisa|kese|kesi|kesa|hoon|hu|hai|hain|aap|tum|tu|tumhe|tumko|mujhe|mujhko|meri|mera|mere|hum|yaad|baat|baatein|pyaar|pyar|soch|socha|karein|karega|karegi|karo|kar|kya|batao|bataiye|kaho|jaan|theek|suno|sunona|accha|achha|bahut|bohot|dil|mann|kuch|kabhi|aaj|kal|chaloge|pioge|khana|khaya|samjhe|kare|karu|raha|rahi|rahe|chahiye|bolo|shona|sona|dekh|dekho|pehle|karenge|aapse|tumse|tha|thi|the|gaya|gayi|gaye|kiya|yaar|kya kar rahi|kya kar raha|tu aaj kya|kaise ho)\b/i;
